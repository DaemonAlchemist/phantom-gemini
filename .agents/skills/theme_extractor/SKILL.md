...
description: Use this skill to analyze a drafted chapter or outline to determine the emergent theme and underlying arguments being made by the characters' actions.
---

# Theme Extractor Skill Instructions

When triggered, your goal is to help the author understand the subtextual meaning of their work.

## Workflow

1. **Read the Text:** Review the provided chapter draft or outline. 
